...
func bibleReferenceConstructorsAlwaysSetVerseEndWhenVerseStartExists() throws {
    let singleVerseReference = BibleReference(versionId: 111, bookId: "GEN", chapter: 1, verse: 3)
    let rangeReference = BibleReference(versionId: 111, bookId: "GEN", chapter: 1, verseStart: 3, verseEnd: 5)
